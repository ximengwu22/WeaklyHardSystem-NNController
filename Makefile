...
all: graph/graph_in_grids.cpp
	...
	@g++ -O3 -c $(CFLAGS) -o graph_in_grids.o graph_in_grids.cpp
	@g++-8 -O3 -w $(LINK_FLAGS) -o ../saw-grids $(CPP) $(OBJ) graph_in_grids.o libbernstein_poly_approx.a $(LIBS) -I../flowstar
	@cd ..

clean:
	@rm -f saw-grids ./graph/*.o ./graph/*.a
	@cd flowstar
	@$(MAKE) clean
	@cd ..
